...
/**
 * Parchea el campo Duration en los metadatos EBML de un blob WebM.
 * Chrome no escribe la duración al grabar con MediaRecorder desde un stream,
 * lo que impide buscar posiciones en el archivo resultante. Parsea la estructura
 * EBML, inserta o actualiza el elemento Duration y devuelve un blob corregido.
 *
 * Acepta tanto callback como Promise: si se omite el callback, devuelve una Promise.
 *
 * @param {Blob} blob
